...
public class testMethod {
	...
	public void setup() {
		...
		System.setProperty("webdriver.chrome.driver","C:\\Users\\Yehya\\Desktop\\Selenium 23-2\\chromedriver.exe");
	...
	public void selectSuggestion() {
		...
		String[] splittedSuggestionValue = suggestionValue.split(" ", 3);
	...
	//verify that the user can search for a value in Arabic with google in English
	
	//go back after making search and make new search
	
	//verify that the user can reinsert the search value
	
	//verify that the user can make new search through the result page
	
	//verify that the user can't search for an empty value
	
	//verify that the user can search for a value in English with google in Arabic
	
	//verify that the user can search for a value in Arabic with google in Arabic
	
	//clicking the search box before and after making search
